...
- [`modulo-04-artillery.md`](modulo-04-artillery.md) — módulo 4 (`Artillery`): definición data-driven de piezas, Actor de pieza con posición geográfica y estado operativo, laying (azimut/elevación con límites y velocidades), inventario, historial de disparos, catálogo y roster/selección (32/32 en verde).

Los próximos módulos (Hardware, Simulation, Networking, VR) añaden un archivo `modulo-NN-<nombre>.md` cada uno a medida que se completan, siguiendo el orden descrito en `arquitectura.md`.
